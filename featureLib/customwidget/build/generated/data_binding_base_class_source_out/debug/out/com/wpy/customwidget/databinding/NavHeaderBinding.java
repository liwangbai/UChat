...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull RelativeLayout rootView, @NonNull CircleImageView ivHead,
      @NonNull TextView tvId, @NonNull TextView tvNickname) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderBinding((RelativeLayout) rootView, ivHead, tvId, tvNickname);
    }
